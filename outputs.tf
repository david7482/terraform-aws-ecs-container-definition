...
locals {
  ...
  encoded_cpu                   = "${var.container_cpu == 0 ? "null" : var.container_cpu}"
  encoded_memory                = "${var.container_memory == 0 ? "null" : var.container_memory}"
  encoded_memory_reservation    = "${var.container_memory_reservation == 0 ? "null" : var.container_memory_reservation}"
